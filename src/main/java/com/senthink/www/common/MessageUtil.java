...
import com.senthink.www.domain.po.wechat.*;
...
public class MessageUtil {
     ...
     */
    @SuppressWarnings("unchecked")
    public static Map<String, String> parseXml(HttpURLConnection conn) throws Exception {
        // 将解析结果存储在HashMap中
        Map<String, String> map = new HashMap<String, String>();
    ...
    public static String jsonToXml(JSONObject jsonObject) {
        xstream.alias("xml", jsonObject.getClass());
